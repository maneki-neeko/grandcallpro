...
const ConsentForm: React.FC = () => {
  ...
  return (
    <div className="consent-form">
      ...
      <p>
        Ao continuar, você concorda com os termos de uso e a política de privacidade conforme
          ...
          <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
            <DialogContent>
              ...
              <div className="modal-content">
                <p>
                  Este é o termo de aceite conforme exigido pela Lei Geral de Proteção de Dados
                  (LGPD). Ao aceitar, você concorda com o uso de seus dados conforme descrito neste
                  documento.
                </p>
