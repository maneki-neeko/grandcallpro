            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <label htmlFor="lgpd" className="text-sm">
                  Eu aceito os <button type="button" className="text-primary hover:underline" onClick={() => setIsModalOpen(true)}>termos da LGPD</button>.
                </label>
              </div>
            </div>
          </CardContent>
          <div className="flex flex-col gap-2 p-4">
            <Button onClick={handleRegister} className="w-full bg-[#1bb5da] hover:bg-[#004a80] text-white font-bold font-sora">
              Registrar
            </Button>
